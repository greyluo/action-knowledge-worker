...
SEED_ENTITY_TYPES = [
    {"name": "Entity", "parent_name": None, "fields": {"id": "uuid"}, "description": "Base entity type"},
    {"name": "Agent", "parent_name": "Entity", "fields": {"spec_id": "uuid", "name": "str"}, "description": "An agent running on a spec"},
    {"name": "Run", "parent_name": "Entity", "fields": {"spec_id": "uuid", "started_at": "datetime"}, "description": "A single execution run"},
    {"name": "Task", "parent_name": "Entity", "fields": {
        "title": "str", "description": "str",
        "status": "str",
        "outcome_summary": "str",
    }, "description": "A unit of work persisting across sessions"},
]
